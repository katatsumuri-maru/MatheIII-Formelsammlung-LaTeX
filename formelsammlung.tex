...
\frac{\partial^2 f}{\partial x_m \partial x_1} & \frac{\partial^2 f}{\partial x_m \partial x_2} &\dots &\frac{\partial^2 f}{\partial  x_m \partial x_n}\\
\end{bmatrix}
$$
...
$
T(a+h) = J_f(a)h + \frac{1}{2} h^T H_f(a)h + R\cdot (x_1^2, \dots, x_n^2)
$
